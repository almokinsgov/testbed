// Extracted first-pass shared helpers from the standalone source file.
  ...
  function normalizeWord(input){
    ...
    return String(input).normalize('NFC').trim().toLowerCase().replace(/\u00AD/g,'');
  }
  ...
  const STORAGE_KEYS = {
    ...
    contentDetectPrefs: 'reorite_segmenter_v12_content_detect_prefs',
    contentDetectText: 'reorite_segmenter_v12_content_detect_text',
  ...
  function setActiveTab(tab){
    ...
    document.getElementById('tabContentTeReoDetect').classList.toggle('active', tab === 'contentTeReoDetect');
    ...
    document.getElementById('pageContentTeReoDetect').classList.toggle('hidden', tab !== 'contentTeReoDetect');
