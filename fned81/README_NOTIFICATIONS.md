...
They also require a secure origin. If you are testing on a phone using a local IP address like http://192.168.x.x the browser will usually block Notification API access. In that case FNED will show toasts only and the CTA will display "Toasts Only".
